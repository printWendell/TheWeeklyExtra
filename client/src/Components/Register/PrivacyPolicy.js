...
function PrivacyPolicy() {
  return (
    <div>
      <h1>Privacy Policy for TheWeeklyExtra</h1>
      <br />

      <p>
        At TheWeeklyExtra, accessible from
        https://theweeklyextra.herokuapp.com/, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by TheWeeklyExtra and how we
        use it.
      </p>
      ...
      <p>
        TheWeeklyExtra follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, TheWeeklyExtra uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of TheWeeklyExtra.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on TheWeeklyExtra, which are sent
      ...
      <p>
        Note that TheWeeklyExtra has no access to or control over these cookies
      ...
      <p>
        TheWeeklyExtra's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        TheWeeklyExtra does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in TheWeeklyExtra. This policy is not applicable
      ...
      <br />
      <p>
        <strong>Note!:</strong> Everything listed above doesn't matter. If you
        actually read this, wow you're dedicated. Please hire me.
      </p>
    </div>
  );
}
