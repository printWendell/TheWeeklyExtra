...
function Terms() {
  return (
    <div>
      ...
      <p>Welcome to TheWeeklyExtra!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of TheWeeklyExtra's Website, located at
        https://theweeklyextra.herokuapp.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use TheWeeklyExtra if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing TheWeeklyExtra, you agreed to
        use cookies in agreement with the TheWeeklyExtra's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, TheWeeklyExtra and/or its licensors own the
        intellectual property rights for all material on TheWeeklyExtra. All
        intellectual property rights are reserved. You may access this from
        TheWeeklyExtra for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from TheWeeklyExtra</li>
        <li>Sell, rent or sub-license material from TheWeeklyExtra</li>
        <li>Reproduce, duplicate or copy material from TheWeeklyExtra</li>
        <li>Redistribute content from TheWeeklyExtra</li>
      </ul>
      ...
      <p>
        ...
        TheWeeklyExtra does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of TheWeeklyExtra,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, TheWeeklyExtra
      ...
      <p>
        TheWeeklyExtra reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant TheWeeklyExtra a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of TheWeeklyExtra; and (d) the
      ...
      <p>
        ...
        e-mail to TheWeeklyExtra. Please include your name, your organization
      ...
      <p>
        No use of TheWeeklyExtra's logo or other artwork will be allowed for
      ...
      <br />
      <p>
        <strong>Note!:</strong>None of what your just "read" matters. Please
        hire me.
      </p>
    </div>
  );
